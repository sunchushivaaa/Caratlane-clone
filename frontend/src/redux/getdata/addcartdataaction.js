...
export const getDataCart = () => (dispatch) => {
  ...
  return axios
    .get(`https://gold-jittery-chameleon.cyclic.app/cart`, {
      headers: {
        Authorization: token,
      },
    })
...
export const addDataCart = (data) => (dispatch) => {
  ...
  return axios
    .post(`https://gold-jittery-chameleon.cyclic.app/cart/add`, data, {
      headers: {
        Authorization: token,
      },
    })
...
export const updateDataCart = (data) => (dispatch) => {
  ...
  return axios
    .patch(
      `https://gold-jittery-chameleon.cyclic.app/cart/patch/${data._id}`,
      data,
      {
        headers: {
          Authorization: token,
...
export const deleteDataCart = (data) => (dispatch) => {
  ...
  return axios
    .delete(`https://gold-jittery-chameleon.cyclic.app/cart/delete/${data}`, {
      headers: {
        Authorization: token,
      },
    })
