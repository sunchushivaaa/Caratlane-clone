...
export const getDataRing = (id) => (dispatch) => {
  ...
  return axios
    .get(`https://gold-jittery-chameleon.cyclic.app/ring/getbyid/${id}`, {
      headers: {
        Authorization: token,
      },
    })
...
export const getDatabracelet = (id) => (dispatch) => {
  ...
  return axios
    .get(`https://gold-jittery-chameleon.cyclic.app/bracelet/getbyid/${id}`, {
      headers: {
        Authorization: token,
      },
    })
...
export const getDataearings = (id) => (dispatch) => {
  ...
  return axios
    .get(`https://gold-jittery-chameleon.cyclic.app/earring/getbyid/${id}`, {
      headers: {
        Authorization: token,
      },
    })
...
export const getDatamangalsutra = (id) => (dispatch) => {
  ...
  return axios
    .get(
      `https://gold-jittery-chameleon.cyclic.app/mangalsutra/getbyid/${id}`,
      {
        headers: {
          Authorization: token,
        },
    ...
    .then((res) =>
      dispatch({ type: GET_MANGALSUTRA_SUCCESS, payload: res.data })
    )
