...
const PaymentPage = () => {
    ...
    return (
        <Box>
            <Box width="100%" height={["60px", "60px", "80px", "80px"]} position="fixed"  background="white" boxShadow="rgba(0, 0, 0, 0.05) 0px 0px 0px 1px, rgb(209, 213, 219) 0px 0px 0px 1px inset">
                <Box width={["10%","10%","5%","5%"]} >
            ...
            <Box width={["100%", "100%", "60%", "60%"]} paddingTop={["20%","20%","7%","7%"]}>
                <Box>
                    ...
                    <Box className='order_box'>
                        <form action="" onSubmit={handleSubmit}>
                            ...
                            <select name="Select State" >
                                ...
                                <option> Maha Rashtra </option>
                                <option>  </option>
                                <option>  </option>
                                <option>  </option>
                            </select>
                            <select placeholder='Select State' border="1px solid red">
                                <option> </option>
                                <option>  </option>
                                <option>  </option>
                                <option>  </option>
