...
import { getMangalsutraData } from '../data';
...
const Ring = () => {
    ...
    const fetchData = async () => {
        try {
            const data = await getMangalsutraData()
            // console.log(data);
            setRing(data)
        }
        catch (e) {
    ...
    return (
        <div className='Ring-container'>
            <img className='bannerImage' src="https://banner.caratlane.com/live-images/ed19e9fc6ddd4de592b67776543499c1.jpg" alt="Banner_Image" />
            <div >
                <div className='Ring-subNavbar' >
                    ...
                    <div className='accending-decending'>
                        <select name="" id="" value={sortOrder} onChange={(e) => setData(e.target.value)}>
                            ...
                            <div className='filter'>
                                <div className='filter-by-price'>
                                    ...
                                    <div className='radioBtn-section'>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "under5000"} onChange={() => setSelectedPriceRange("under5000")} type="radio" />
                                            <label htmlFor="">Under 5,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between5001and10000"} onChange={() => setSelectedPriceRange("between5001and10000")} type="radio" />
                                            <label htmlFor="">5,001 - 10,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between10001and15000"} onChange={() => setSelectedPriceRange("between10001and15000")} type="radio" />
                                            <label htmlFor="">10,001 - 15,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" type="radio" checked={selectedPriceRange === "between15001and20000"} onChange={() => setSelectedPriceRange("between15001and20000")} />
                                            <label htmlFor="">15,001 - 20,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between20001and30000"} onChange={() => setSelectedPriceRange("between20001and30000")} type="radio" />
                                            <label htmlFor="">20,001 - 30,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between30001and40000"} onChange={() => setSelectedPriceRange("between30001and40000")} type="radio" />
                                            <label htmlFor="">30,001 - 40,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between40001and50000"} onChange={() => setSelectedPriceRange("between40001and50000")} type="radio" />
                                            <label htmlFor="">40,001 - 50,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between50001and75000"} onChange={() => setSelectedPriceRange("between50001and75000")} type="radio" />
                                            <label htmlFor="">50,001 - 75,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between75001and100000"} onChange={() => setSelectedPriceRange("between75001and100000")} type="radio" />
                                            <label htmlFor="">75,001 - 1,00,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between100001and150000"} onChange={() => setSelectedPriceRange("between100001and150000")} type="radio" />
                                            <label htmlFor="">1,00,001 - 1,50,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between150001and200000"} onChange={() => setSelectedPriceRange("between150001and200000")} type="radio" />
                                            <label htmlFor="">1,50,001 - 2,00,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "between200001and250000"} onChange={() => setSelectedPriceRange("between200001and250000")} type="radio" />
                                            <label htmlFor="">2,00,001 - 2,50,000</label>
                                        </div>
                                        <div>
                                            <input name="radioBtn" checked={selectedPriceRange === "over25000"} onChange={() => setSelectedPriceRange("over25000")} type="radio" />
                            ...
                            filtering.length === 0 ? <>
                                {ringData.map((ele, index) => (
                                    <div key={index} className='singleProd'>
                                        ...
                                        <h3 className='rupee'><BiRupee /><span>{ele.MRP}</span></h3>
                                        <p className='deliveryDate'>Check delivery date <span><FaGreaterThan /></span></p>
                                        <p className='Singletitle'>{ele.name}</p>
                                        <div className='btn'>
                                            <button><ImHome3 /> <span>Book Try at Home</span></button>
                                            <button><FcVideoCall /> <span>Live Video Call</span></button>
                                        </div>
                                    </div>
                                ))}</> : <>
                                {
